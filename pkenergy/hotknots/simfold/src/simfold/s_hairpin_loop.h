...
public:
  ...
  // compute the free energy if this is restricted to be a hairpin loop, closed
  // at (i,j)

  static PARAMTYPE get_energy(int i, int j, int *sequence, char *csequence,
                              int *ptable = NULL);
  ...
  static void count_get_energy(int i, int j, int *sequence, char *csequence,
                               double *counter);
...
protected:
  ...
  char *csequence; // the sequence a array of chars. We need it here for
