...
public:
  ...
  // computes the MFE of the structure closed by an internal loop closed at
  // (i,j)

  PARAMTYPE compute_energy_restricted(int i, int j, str_features *fres);
  // computes the MFE of the structure closed by a restricted internal loop
  // closed by (i,j)
  ...
  static PARAMTYPE get_energy(int i, int j, int ip, int jp, int *sequence,
                              int *ptable = NULL);
  ...
  static void count_get_energy(int i, int j, int ip, int jp, int *sequence,
                               double *counter);
