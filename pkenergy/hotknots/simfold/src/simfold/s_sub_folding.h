...
public:
  ...
  long get_num_partial_structures_thrown_away() {
    return num_partial_structures_thrown_away;
  };
...
protected:
  ...
  // Use two temporary variable cur_intevral for the interval that is being
  // backtracked
  ...
  // having "limit" partial structures, the energy of the last suboptimal
  // structure (i.e. max_energy) will be at least as low as the energy of the
  // last partial structure.
